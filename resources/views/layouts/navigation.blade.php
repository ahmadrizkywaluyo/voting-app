<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->role === 'admin')
                        <x-nav-link href="/admin/polls"
                            :active="request()->is('admin/polls*')">
                            Manajemen Polling
                        </x-nav-link>
                        ...
                        <x-nav-link href="/admin/reports/polls"
                            :active="request()->is('admin/reports*')">
                            Laporan
                        </x-nav-link>
                    @else
                    {{-- USER --}}
                        <x-nav-link href="/polls"
                            :active="request()->is('polls*')">
                            Voting
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role === 'admin')
                <x-responsive-nav-link href="/admin/polls"
                    :active="request()->is('admin/polls*')">
                    Manajemen Polling
                ...
                <x-responsive-nav-link href="/admin/reports/polls"
                    :active="request()->is('admin/reports*')">
                    Laporan
                </x-responsive-nav-link>
            @else
                <x-responsive-nav-link href="/polls"
                    :active="request()->is('polls*')">
                    Voting
                </x-responsive-nav-link>
            @endif
